...
class ConversationContextTest {
  ...
  void shouldStoreConstructorParameters() {
    ...
    var ctx = new ConversationContext("whatsapp:+31612345678", "incident-123", "C12345", now, true);
  ...
  void shouldIncludeAllValuesInToString() {
    var ctx =
        new ConversationContext("uX", "iY", "cZ", Instant.parse("2025-11-03T12:00:00Z"), false);
