...
class ConversationContextServiceTest {
    ...
    class HasActiveContextTests {
        ...
        void shouldReturnFalseWhenNoContext() {
            // Given
            var command = CreateIncidentCommand.builder()
                    .reporterId("user-1")
    ...
    class FindValidUpdateContextTests {
        ...
        void shouldReturnNullWhenExpired() {
            ...
            var oldCtx = new ConversationContext(
                    "u1", "i1", "c1",
        ...
        @Test
        @DisplayName("should update repository and return UpdateIncidentCommand when active context exists")
        void shouldUpdateAndReturnCommand() {
            ...
            var ctx = new ConversationContext("u1", "i1", "c1",
                    now.minus(Duration.ofHours(1)), true);
