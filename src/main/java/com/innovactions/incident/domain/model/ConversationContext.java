 ...
 *
 * @param userId WhatsApp phone number; can be extended to support other platforms (e.g. slack and
 *     email)
...
public record ConversationContext(
    String userId, String incidentId, String channelId, Instant lastMessageAt, boolean active) {}
