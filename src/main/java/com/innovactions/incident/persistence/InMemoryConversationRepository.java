...
public class InMemoryConversationRepository implements ConversationRepositoryPort {
     ...
     * checks if there is an ongoing conversation for the user
    */
     ...
     * <p>
     * invoked when an incident is first created or
     * when an existing conversation has expired.
     */
    @Override
     ...
     * <p>
     * Called when a message arrives and conversation context for the user already existed and not expired
     */
    @Override
